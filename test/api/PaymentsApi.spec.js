...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MinergateApi.PaymentsApi();
  });
  ...
  describe('PaymentsApi', function() {
    describe('getInvoiceById', function() {
      it('should call getInvoiceById successfully', function(done) {
        //uncomment below and update the code to test getInvoiceById
        //instance.getInvoiceById(function(error) {
