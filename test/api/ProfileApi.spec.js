...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MinergateApi.ProfileApi();
  });
  ...
  describe('ProfileApi', function() {
    describe('getProfileNickname', function() {
      it('should call getProfileNickname successfully', function(done) {
        //uncomment below and update the code to test getProfileNickname
        //instance.getProfileNickname(function(error) {
