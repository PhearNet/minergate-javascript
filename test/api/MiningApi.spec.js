...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MinergateApi.MiningApi();
  });
  ...
  describe('MiningApi', function() {
    describe('getWorkers', function() {
      it('should call getWorkers successfully', function(done) {
        //uncomment below and update the code to test getWorkers
        //instance.getWorkers(function(error) {
    ...
    describe('miningStats', function() {
      it('should call miningStats successfully', function(done) {
        //uncomment below and update the code to test miningStats
        //instance.miningStats(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
